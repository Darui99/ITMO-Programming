...
public class Tokenizer<T> {
    ...
    public Tokenizer(String expression, Calculator<T> calculator) {
        i = 0;
        braceBalance = 0;
        ...
        allowedOperations.put("square", Component.SQR);
        allowedOperations.put("mod", Component.MOD);
    }
    ...
    public T getConst(StringBuilder curConst) throws EvaluateException {
        try {
            T res = calculator.convertString(curConst.toString());
